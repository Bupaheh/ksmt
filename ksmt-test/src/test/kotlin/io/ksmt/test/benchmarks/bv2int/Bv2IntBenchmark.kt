...
class Bv2IntBenchmark : BenchmarksBasedTest() {
    ...
    private val solvers: List<Pair<KClass<KSolver<KSolverConfiguration>>, String>> = listOf(
        ...
        KZ3EagerSumUnsigned::class to "Z3-Eager-Sum-Unsigned",
        KZ3EagerBitUnsigned::class to "Z3-Eager-Bit-Unsigned",
        ...
        KZ3EagerSumSignedLazyOverflowUnsigned::class to "Z3-Eager-Sum-SignedLazyOverflow-Unsigned",
        KZ3EagerBitSignedLazyOverflow::class to "Z3-Eager-Bit-SignedLazyOverflow",
        ...
        KYicesEagerBitUnsigned::class to "Yices-Eager-Bit-Unsigned",
        KYicesEagerSumSigned::class to "Yices-Eager-Sum-Signed",
        KCvc5EagerSumUnsigned::class to "Cvc5-Eager-Sum-Unsigned",
        KCvc5EagerBitUnsigned::class to "Cvc5-Eager-Bit-Unsigned",
